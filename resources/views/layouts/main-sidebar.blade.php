			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/categorys') }}">اضافه قسم</a></li>
                    ...
                    ********************
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='login') }}">login</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='register') }}">register</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='logout') }}">logout</a></li>
