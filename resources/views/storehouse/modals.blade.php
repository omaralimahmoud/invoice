        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    ...
                    <a class="btn ripple btn-info" data-target="#modaldemo3" data-toggle="modal" href="">اضف في المخزن</a>
            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="" class=" text-primary">الكود</label>
                            <input type="number" class=" form-control">
                        </div>
                        <div class="col-md-6">
                            <label for="" class=" text-primary">سعرالشراء</label>
                            <input type="number" class=" form-control">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="" class=" text-primary">اسم المنتج</label>
                            <input type="text" class=" form-control">
                        </div>
                        <div class="col-md-6">
