    ...
    <form action="{{ url('/invoice/store') }}" method="post" id="printJS-form">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4 my-3">
                ...
                @enderror
                <input class="form-control" type="text" placeholder="اسم العميل" name="customerNameInvoice"
            ...
            <div class="col-md-4 my-3">
                ...
                @enderror
                <input class="form-control" placeholder="رقم تلفون العميل" type="number" name="CustomerPhoneNumberInvoice"
...
@section('script')
    ...
    <script>
      ...
      <div class="col-md-3">
          <td><input required onkeyup="getCod(${x})" type="number" id="itemCode-${x}" class="itemCode"
                  placeholder="كود الصنف"></td>
      </div>
      ...
      <div class="col-md-3">
          <td><input type="number" required id="quantityInvoice-${x}" name="quantityInvoice[]" class="itemCode" placeholder="الكميه"></td>
      </div>
      <div class="col-md-3">
