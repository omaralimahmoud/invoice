            ...
            <div class="card">
                    ...
                    {{-- <form action="{{ url('/storehouse/search') }}" class="no-print">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input  class=" form-control mt-2  no-print" type="text" id="itemCodeAstielam">
                            </div>
                            <div class="col-md-3">
                                <label for="" class=" text-primary">اسم الصنف</label>
                                <input class=" form-control mt-2   no-print " type="text" id="itemNameAstielam">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class=" form-control mt-2 no-print" name="from" type="date">
                            </div>
                            <div class="col-md-3">
                                <label for="" class=" text-primary">الى تاريخ</label>
                                <input class=" form-control mt-2  no-print" name="to" type="date">
                            </div>
                            <div class="col-md-3">
                                <input class=" form-control mt-2 bg-primary text-white no-print" type="submit" value="تاكيد">
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table   wid"      id="example1">
                            <thead  >
                                <tr  >
                                    <th class="wd-15p border-bottom-0">مسلسل</th>
                                    <th class="wd-15p border-bottom-0  spac">كود المخزن</th>
                                    <th class="wd-15p border-bottom-0 spac">اسم المخزن</th>
                                    <th class="wd-15p border-bottom-0 spac">كود المورد</th>
                                    <th class="wd-15p border-bottom-0 spac"> اسم المورد</th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" required class=" form-control" id="supplierCode">
                            </div>
                            <div class="col-md-6">
                                <label for="" class=" text-primary"> اسم المورد </label>
                                <input type="text" required class=" form-control" id="supplierName">
                            ...
                            <div class="col-md-6">
                                <label for="" class=" text-primary">كود الصنف</label>
                                <input type="text" required class=" form-control" id="itemCode">
                            </div>
                            <div class="col-md-6">
                                <label for="" class="text-primary">اسم الصنف</label>
                                <input type="text" required class=" form-control" id="itemName">
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="" class=" text-primary">كود الصنف</label>
                                <input type="text" id="edit-form-itemProductCode" readonly class=" form-control read">
                            </div>
                            <div class="col-md-6">
                                <label for="" class=" text-primary">اسم الصنف</label>
