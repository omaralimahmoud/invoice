...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اقسام المنتجات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">
                </span>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    ...
                    <a class="btn ripple btn-info" data-target="#modaldemo3" data-toggle="modal" href=""> اضف قسم المنتجات </a>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title"> اضف قسم المنتجات </h6><button aria-label="Close" class="close"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label for="" class=" text-primary">قسم المنتج</label>
                ...
                <div class="modal-footer">
                    <button class="btn ripple btn-primary" type="button">تاكيد</button>
